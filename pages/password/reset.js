...
export default function ResetPassword() {
    ...
    const passwordReset = async (e) => {
        ...
        const { toastSuccess, toastError } = toastLoader("Resetting your password...")
        ...
        try {
            ...
            toastSuccess("Your password has been reset! You'll be redirected to login shortly")
            router.push('/signin')

        } catch (error) {
            console.log(error)
            toastError("An error has occurred while attempting to reset the password")
            setLoading(false)
        }
    ...
    return (
        ...
        <>
            <Head>
                <title>Wired - Password Reset</title>
            </Head>
            ...
            <div className={Styles.container}>
                <div className={Styles.loginForm}>
                    ...
                    <form onSubmit={passwordReset} className={Styles.form}>
                        <input
                            name={"email"}
                            type={"email"}
                            maxLength={255}
